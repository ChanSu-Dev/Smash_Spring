		...
		<div class="container my-auto">
			<div class="row">
				<div class="col-lg-2 mx-auto">
					<img
						src="${pageContext.request.contextPath}/resources/img/login_logo.png"
						height="130px">
				</div>
			</div>
			<div class="row">
